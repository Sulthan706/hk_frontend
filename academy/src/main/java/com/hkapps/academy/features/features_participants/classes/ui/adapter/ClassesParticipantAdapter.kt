package com.hkapps.academy.features.features_participants.classes.ui.adapter
...
class ClassesParticipantAdapter(
    var listClass: ArrayList<Content>
): RecyclerView.Adapter<ClassesParticipantAdapter.ViewHolder>() {
