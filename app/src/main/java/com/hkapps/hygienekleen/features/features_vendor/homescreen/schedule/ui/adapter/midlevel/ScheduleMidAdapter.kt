package com.hkapps.hygienekleen.features.features_vendor.homescreen.schedule.ui.adapter.midlevel
...
import com.hkapps.hygienekleen.databinding.ItemScheduleCalendarBinding
import com.hkapps.hygienekleen.features.features_vendor.homescreen.schedule.model.midlevel.MidDataArrayContent
import java.text.SimpleDateFormat
import java.util.*


class ScheduleMidAdapter(
    private var context: Context? = null,
    var schContent: ArrayList<MidDataArrayContent>
) :
    RecyclerView.Adapter<ScheduleMidAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(
            ItemScheduleCalendarBinding.inflate(
    ...
    inner class ViewHolder(val binding: ItemScheduleCalendarBinding) :
