...
import com.hkapps.hygienekleen.databinding.FragmentListTeamLeaderProfileProjectBinding
...
class ListTeamLeaderProfileProjectFragment : Fragment(), ListOperationalProfileProjectAdapter.ListOperationalProfileProjectCallback {

    private lateinit var binding: FragmentListTeamLeaderProfileProjectBinding
    ...
    private val jobRole = "Team Leader"
    ...
    override fun onCreateView(
        ...
        binding = FragmentListTeamLeaderProfileProjectBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun viewIsOnline(){
        //set shimmer effect
        binding.shimmerListTeamLeaderProfileProject.startShimmerAnimation()
        binding.shimmerListTeamLeaderProfileProject.visibility = View.VISIBLE
        binding.rvListTeamLeader.visibility = View.GONE
        binding.flListTeamLeaderNoInternet.visibility = View.GONE
        binding.flListTeamLeaderNoData.visibility = View.GONE

        val layoutManager = LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false)
        binding.rvListTeamLeader.layoutManager = layoutManager
        ...
        binding.rvListTeamLeader.addOnScrollListener(scrollListener)
        loadData()
        setObserver()
    }
            ...
            if (isLoading != null) {
                if (isLoading) {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.shimmerListTeamLeaderProfileProject.stopShimmerAnimation()
                        binding.shimmerListTeamLeaderProfileProject.visibility = View.GONE
                        binding.rvListTeamLeader.visibility = View.VISIBLE
                    }, 1500)
                }
            }
        })
            ...
            if(it.code == 200){
                if(it.data.content.isNotEmpty()){
                    ...
                    if(page == 0){
                        ...
                        binding.rvListTeamLeader.adapter = adapter
                    }else{
    ...
    private fun noInternetState() {
        ...
        binding.rvListTeamLeader.visibility = View.GONE
        binding.flListTeamLeaderNoData.visibility = View.GONE
        binding.flListTeamLeaderNoInternet.visibility = View.VISIBLE
    ...
    private fun noDataState() {
        ...
        binding.rvListTeamLeader.visibility = View.GONE
        binding.flListTeamLeaderNoInternet.visibility = View.GONE
        binding.flListTeamLeaderNoData.visibility = View.VISIBLE
    }
