...
import com.hkapps.hygienekleen.databinding.FragmentBotUpdateNumbBpjsMgmntBinding
import com.hkapps.hygienekleen.pref.CarefastOperationPref
import com.hkapps.hygienekleen.pref.CarefastOperationPrefConst
import com.google.android.material.bottomsheet.BottomSheetDialogFragment


class BotUpdateNumbBpjsMgmntFragment(val tittle : String? = null) : BottomSheetDialogFragment() {
    private lateinit var binding: FragmentBotUpdateNumbBpjsMgmntBinding
...
//    private  var emptyBody: MultipartBody.Part? = null

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentBotUpdateNumbBpjsMgmntBinding.inflate(layoutInflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnUploadDocumentBpjs.setOnClickListener {
            ...
            BotUploadBpjsMgmntFragment().show(requireFragmentManager(),"uploaddocument")
            dismiss()
        }
