...
class CountProjectDateNewAdapter(var listCountProject: ArrayList<LastProgres>):
    RecyclerView.Adapter<CountProjectDateNewAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: ListDateProjectVisitBinding):
        ...
        override fun onClick(p0: View?) {
            ...
            countProjectCallBack.onClickItem(selected.dateFormat, selected.totalProject)
        }
