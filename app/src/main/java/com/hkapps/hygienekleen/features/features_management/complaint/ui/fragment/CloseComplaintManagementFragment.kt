...
import com.hkapps.hygienekleen.databinding.FragmentCloseComplaintManagementBinding
...
class CloseComplaintManagementFragment : Fragment(), ComplaintManagementByStatusAdapter.ComplaintByStatusCallBack {

    private lateinit var binding: FragmentCloseComplaintManagementBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCloseComplaintManagementBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvListComplaintManagementClose.layoutManager = layoutManager
...
//        binding.swipeListComplaintManagementClose.setOnRefreshListener(SwipeRefreshLayout.OnRefreshListener {
//            Handler().postDelayed(
//                Runnable {
//                    binding.swipeListComplaintManagementClose.isRefreshing = false
...
//            )
//        })
        binding.rvListComplaintManagementClose.addOnScrollListener(scrollListener)
            ...
            if (isLoading != null) {
                if (isLoading) {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.shimmerListComplaintManagementClose.stopShimmerAnimation()
                        binding.shimmerListComplaintManagementClose.visibility = View.GONE
                        binding.rvListComplaintManagementClose.visibility = View.VISIBLE
                    }, 1500)
                }
            }
        })
        viewModel.getListComplaintManagementResponse().observe(requireActivity()) {
            if (it.code == 200) {
                if (it.data.content.isNotEmpty()) {
                    binding.llEmptyListComplaintManagementClose.visibility = View.GONE
                    ...
                    if (page == 0) {
                        ...
                        binding.rvListComplaintManagementClose.adapter = rvAdapter
                    } else {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.llEmptyListComplaintManagementClose.visibility = View.VISIBLE
                    }, 1500)
                }
            } else {
