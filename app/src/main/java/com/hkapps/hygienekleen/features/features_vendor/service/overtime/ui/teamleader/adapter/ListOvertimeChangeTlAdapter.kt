...
class ListOvertimeChangeTlAdapter(
    private var context: Context,
    var listOvertime: ArrayList<Content>
) : RecyclerView.Adapter<ListOvertimeChangeTlAdapter.ViewHolder>() {

    private lateinit var listOvertimeChangeTlCallback: ListOvertimeChangeTlCallback
...
//        }
        ...
        override fun onClick(p0: View?) {
            val response = listOvertime[adapterPosition]
            listOvertimeChangeTlCallback.onClickItem(response.employeeId)
        }
            ...
            when (response.statusAttendance) {
                ...
                "Sakit", "SAKIT", "SAKIT SURAT", "Sakit Surat", "Sakit surat" -> {
                    ...
                    holder.binding.rlListOvertimeChange.setOnClickListener {
                        ...
                        context.startActivity(Intent(context, CreateOvertimeChangeMidActivity::class.java))
                    }
                }
                else -> {
    ...
    fun setListener(listOvertimeChangeTlCallback: ListOvertimeChangeTlCallback) {
        this.listOvertimeChangeTlCallback = listOvertimeChangeTlCallback
    }

    interface ListOvertimeChangeTlCallback {
