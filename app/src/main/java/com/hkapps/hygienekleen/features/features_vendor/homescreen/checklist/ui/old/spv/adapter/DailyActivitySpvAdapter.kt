...
class DailyActivitySpvAdapter(
    private val context: Context,
    var listDailyAct: ArrayList<DailyActivity>,
    var viewModel: ChecklistViewModel
): RecyclerView.Adapter<DailyActivitySpvAdapter.ViewHolder>() {
...
//
            dailyActCallBack.onClickedImage(image)
...
//                holder.tvTime.text = "$hour:$minute"
    ...
    interface DailyActCallBack {
        fun onClickedImage(activityId: String)
    }
