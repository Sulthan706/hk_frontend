...
import com.hkapps.hygienekleen.databinding.ActivityAttendanceMidGeoLocationPhotoBinding
...
class AttendanceMidGeoLocationPhoto : AppCompatActivity() {

    private lateinit var binding: ActivityAttendanceMidGeoLocationPhotoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAttendanceMidGeoLocationPhotoBinding.inflate(layoutInflater)
...
//        viewModel.postAttendanceGeo(employeeId, projectCode, schId, image)
        ...
        //if alfabeta error directly absen
