...
import com.hkapps.hygienekleen.databinding.FragmentZoomSliderNewsBinding

class ZoomSliderNewsFragment : Fragment() {
    private lateinit var binding: FragmentZoomSliderNewsBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        binding = FragmentZoomSliderNewsBinding.inflate(layoutInflater)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val urlData = arguments?.getString("imageZoom")
        Log.d("agrikece","asd $urlData")
        loadImage(urlData, binding.ivZoomImageNews, binding.progressBarZoomImage)
    }
