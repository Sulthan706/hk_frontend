...
class ClientsSendMeetingAdapter(
    private val context: Context,
    var listClient: ArrayList<Data>
): RecyclerView.Adapter<ClientsSendMeetingAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: ListClientMeetingBinding):
        ...
        override fun onClick(p0: View?) {
            ...
            clientsSendMailCallback.onClickClients(selected.clientId, selected.clientName, selected.clientEmail)
        }
