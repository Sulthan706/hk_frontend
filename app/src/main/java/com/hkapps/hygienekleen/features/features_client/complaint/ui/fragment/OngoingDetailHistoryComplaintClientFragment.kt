...
import com.hkapps.hygienekleen.databinding.FragmentOngoingDetailHistoryComplaintClientBinding
...
class OngoingDetailHistoryComplaintClientFragment : Fragment(), ListComplaintStatusAdapter.HistoryComplaintStatusCallBack {

    private lateinit var binding: FragmentOngoingDetailHistoryComplaintClientBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOngoingDetailHistoryComplaintClientBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // set shimmer effect
        binding.shimmerHistoryComplaintOngoing.startShimmerAnimation()
        binding.shimmerHistoryComplaintOngoing.visibility = View.VISIBLE
        binding.rvHistoryComplaintOngoing.visibility = View.GONE

        // set recycler view
        val layoutManager = LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
        binding.rvHistoryComplaintOngoing.layoutManager = layoutManager
        ...
        binding.swipeHistoryComplaintOngoing.setOnRefreshListener(SwipeRefreshLayout.OnRefreshListener {
            Handler().postDelayed(
                Runnable {
                    binding.swipeHistoryComplaintOngoing.isRefreshing = false
        ...
        binding.rvHistoryComplaintOngoing.addOnScrollListener(scrollListener)
            ...
            if (isLoading != null) {
                if (isLoading) {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.shimmerHistoryComplaintOngoing.stopShimmerAnimation()
                        binding.shimmerHistoryComplaintOngoing.visibility = View.GONE
                        binding.rvHistoryComplaintOngoing.visibility = View.VISIBLE
                    }, 1500)
                }
            }
        })
        viewModel.clientComplaintHistoryResponseModel.observe(requireActivity()) { it ->
            if (it.code == 200) {
                if (it.data.content.isNotEmpty()) {
                    binding.tvEmptycomplaintOngoing.visibility = View.GONE
                    ...
                    if (page == 0) {
                        ...
                        binding.rvHistoryComplaintOngoing.adapter = rvAdapter
                    } else {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.tvEmptycomplaintOngoing.visibility = View.VISIBLE
                    }, 1500)
                }
            } else {
