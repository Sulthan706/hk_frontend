...
import com.hkapps.hygienekleen.databinding.ActivityAttendanceLowGeoLocationLivenessOutBinding
...
class AttendanceLowGeoLocationLivenessOutActivity : AppCompatActivity() {

    private lateinit var binding : ActivityAttendanceLowGeoLocationLivenessOutBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAttendanceLowGeoLocationLivenessOutBinding.inflate(layoutInflater)
...
//                    binding.tvGesture.text = randomizedTasks[currentTaskIndex]
            ...
            override fun onTaskFailed(task: DetectionTask, code: Int) {
                ...
                when (code) {
                    ...
                    LivenessDetector.ERROR_OUT_OF_DETECTION_RECT -> {
                        ...
                        Toast.makeText(
                            this@AttendanceLowGeoLocationLivenessOutActivity,
    ...
    private fun finishForResult(){
        ...
        startActivity(Intent(this,AttendanceLowGeoLocationPhotoOut::class.java).also{
