...
import com.hkapps.hygienekleen.databinding.ActivityUploadDocumentManagementBinding
...
class UploadDocumentManagementActivity : AppCompatActivity() {
    private lateinit var binding: ActivityUploadDocumentManagementBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityUploadDocumentManagementBinding.inflate(layoutInflater)
    ...
    private fun setObserver() {
        homeManagementViewModel.uploadDocumentManagementViewModel().observe(this) {
            if (it.code == 200) {
    ...
    private fun showLoading(loadingText: String) {
        ...
        if (typeDocument == "VAKSIN") {
            homeManagementViewModel.putUploadDocumentManagement(employeeId, image, typeDocument)
            Log.d("IMAGE", "$image")
        } else {
            homeManagementViewModel.putUploadDocumentManagement(employeeId, image, typeDocument)
        }
