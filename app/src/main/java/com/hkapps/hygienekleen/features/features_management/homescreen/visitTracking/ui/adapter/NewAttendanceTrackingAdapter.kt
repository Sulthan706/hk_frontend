...
class NewAttendanceTrackingAdapter(var listAttendance: ArrayList<LastVisit>, private val visibilityDate: String):
    RecyclerView.Adapter<NewAttendanceTrackingAdapter.ViewHolder>() {
