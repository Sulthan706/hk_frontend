...
import com.hkapps.hygienekleen.features.features_vendor.homescreen.checklist.ui.old.teamlead.activity.DetailStaffTlActivity
...
class ChecklistMorningFragment : Fragment(), StaffCheckTlAdapter.StaffCallBack {
...
//    private val userId = CarefastOperationPref.loadInt(CarefastOperationPrefConst.USER_ID, 0)
        ...
        viewModel.staffResponseModel().observe(requireActivity(), {
            if (it.code == 200) {
                if (it.data.isNotEmpty()) {
                    ...
                    adapter = StaffCheckTlAdapter(
                        requireContext(),
                        it.data as ArrayList<DataOperator>
    ...
    override fun onClickedStaff(employeeId: Int) {
        val i = Intent(requireActivity(), DetailStaffTlActivity::class.java)
//        i.putExtra("employeeId", employeeId)
        CarefastOperationPref.saveInt(CarefastOperationPrefConst.EMPLOYEE_ON_CHECKLIST, employeeId)
        startActivity(i)
    }
