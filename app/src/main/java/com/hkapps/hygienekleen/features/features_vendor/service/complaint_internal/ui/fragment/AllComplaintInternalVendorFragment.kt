...
import com.hkapps.hygienekleen.databinding.FragmentAllComplaintInternalVendorBinding
import com.hkapps.hygienekleen.features.features_vendor.service.complaint_internal.ui.adapter.ListComplaintInternalVendorAdapter
...
class AllComplaintInternalVendorFragment : Fragment(), ListComplaintInternalVendorAdapter.ListComplaintInternalCallBack {
    private lateinit var binding: FragmentAllComplaintInternalVendorBinding
    private lateinit var rvAdapter: ListComplaintInternalVendorAdapter
    ...
    override fun onCreateView(
        ...
        binding = FragmentAllComplaintInternalVendorBinding.inflate(inflater, container, false)
        return binding.root
    }
        ...
        viewModel.complaintObs().observe(requireActivity()){
          if(it.code == 200){
              if(it.data.content.isNotEmpty()){
                  ...
                  if(page == 0){
                      rvAdapter = ListComplaintInternalVendorAdapter(requireContext(),
