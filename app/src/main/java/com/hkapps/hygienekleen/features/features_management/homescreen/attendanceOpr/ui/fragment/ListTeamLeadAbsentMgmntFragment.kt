...
import com.hkapps.hygienekleen.databinding.FragmentListTeamLeadAbsentMgmntBinding
...
class ListTeamLeadAbsentMgmntFragment : Fragment(),
    ListOperationalAbsentMgmntAdapter.ListOperationalCallBack {

    private lateinit var binding: FragmentListTeamLeadAbsentMgmntBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentListTeamLeadAbsentMgmntBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // set shimmer effect
        binding.shimmerListTeamLeadAbsent.startShimmerAnimation()
        binding.shimmerListTeamLeadAbsent.visibility = View.VISIBLE
        binding.rvListTeamLeadAbsent.visibility = View.GONE
        binding.flNoDataListTeamLeadAbsent.visibility = View.GONE
        binding.flNoInternetListTeamLeadAbsent.visibility = View.GONE
    ...
    private fun noInternetState() {
        binding.shimmerListTeamLeadAbsent.visibility = View.GONE
        binding.rvListTeamLeadAbsent.visibility = View.GONE
        binding.flNoDataListTeamLeadAbsent.visibility = View.GONE
        binding.flNoInternetListTeamLeadAbsent.visibility = View.VISIBLE
    ...
    private fun noDataState() {
        ...
        binding.rvListTeamLeadAbsent.visibility = View.GONE
        binding.flNoInternetListTeamLeadAbsent.visibility = View.GONE
        binding.flNoDataListTeamLeadAbsent.visibility = View.VISIBLE
    }
    ...
    private fun viewIsOnline() {
        ...
        binding.rvListTeamLeadAbsent.layoutManager = layoutManager
            ...
            if (isLoading != null) {
                if (isLoading) {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.shimmerListTeamLeadAbsent.stopShimmerAnimation()
                        binding.shimmerListTeamLeadAbsent.visibility = View.GONE
                        binding.rvListTeamLeadAbsent.visibility = View.VISIBLE
                    }, 1500)
                }
            }
        })
        viewModel.listCountAbsentOprResponseModel.observe(requireActivity()) {
            if (it.code == 200) {
                if (it.data.isNotEmpty()) {
                    ...
                    binding.rvListTeamLeadAbsent.adapter = rvAdapter
                } else {
                    noDataState()
                }
            } else {
