...
import com.hkapps.hygienekleen.databinding.FragmentDoneComplaintManagementBinding
...
class DoneComplaintManagementFragment : Fragment(), ComplaintManagementByStatusAdapter.ComplaintByStatusCallBack {

    private lateinit var binding: FragmentDoneComplaintManagementBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDoneComplaintManagementBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // set shimmer effect
        binding.shimmerListComplaintManagementDone.startShimmerAnimation()
        binding.shimmerListComplaintManagementDone.visibility = View.VISIBLE
        binding.rvListComplaintManagementDone.visibility = View.GONE

        // set recycler view
        val layoutManager = LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
        binding.rvListComplaintManagementDone.layoutManager = layoutManager
...
//        binding.swipeListComplaintManagementDone.setOnRefreshListener(SwipeRefreshLayout.OnRefreshListener {
//            Handler().postDelayed(
//                Runnable {
//                    binding.swipeListComplaintManagementDone.isRefreshing = false
...
//            )
//        })
        binding.rvListComplaintManagementDone.addOnScrollListener(scrollListener)
            ...
            if (isLoading != null) {
                if (isLoading) {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.shimmerListComplaintManagementDone.stopShimmerAnimation()
                        binding.shimmerListComplaintManagementDone.visibility = View.GONE
                        binding.rvListComplaintManagementDone.visibility = View.VISIBLE
                    }, 1500)
                }
            }
        })
        viewModel.getListComplaintManagementResponse().observe(requireActivity()) {
            if (it.code == 200) {
                if (it.data.content.isNotEmpty()) {
                    binding.llEmptyListComplaintManagementDone.visibility = View.GONE
                    ...
                    if (page == 0) {
                        ...
                        binding.rvListComplaintManagementDone.adapter = rvAdapter
                    } else {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.llEmptyListComplaintManagementDone.visibility = View.VISIBLE
                    }, 1500)
                }
            } else {
