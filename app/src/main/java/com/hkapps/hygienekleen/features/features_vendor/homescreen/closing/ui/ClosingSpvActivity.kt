...
import com.hkapps.hygienekleen.databinding.ActivityClosingSpvBinding
...
class ClosingSpvActivity : AppCompatActivity(){
    ...
    private lateinit var binding : ActivityClosingSpvBinding
    ...
    private fun setViewPager(){
        val fragmentList = arrayListOf(
            GenerateFileFragment(),
            SendEmailClosingFragment()
        )
