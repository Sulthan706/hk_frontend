...
class ReplaceOperationalOvertimeManagementAdapter(
    val listOperational: ArrayList<Data>
) : RecyclerView.Adapter<ReplaceOperationalOvertimeManagementAdapter.ViewHolder>() {

    private lateinit var operationalOvertimeCallback: ReplaceOperationalOvertimeCallback
    var selectedItem = -1
    ...
    inner class ViewHolder(val binding: ListChooseOperatorBinding):
        ...
        override fun onClick(p0: View?) {
            ...
            operationalOvertimeCallback.onClickReplaceOpr(position.idEmployee, position.employeeName, position.employeeJobCode)
    ...
    fun setListener(operationalOvertimeCallback: ReplaceOperationalOvertimeCallback) {
        this.operationalOvertimeCallback = operationalOvertimeCallback
    }

    interface ReplaceOperationalOvertimeCallback {
        fun onClickReplaceOpr(operationalId: Int, operationalName: String, operationalJobCode: String)
    }
}