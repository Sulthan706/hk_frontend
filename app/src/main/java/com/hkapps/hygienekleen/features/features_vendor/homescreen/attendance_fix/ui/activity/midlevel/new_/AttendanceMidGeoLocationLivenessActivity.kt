...
class AttendanceMidGeoLocationLivenessActivity : AppCompatActivity() {

    private lateinit var binding : ActivityAttendanceMidGeoLocationLivenessBinding
...
//                    binding.tvGesture.text = randomizedTasks[currentTaskIndex]
            ...
            override fun onTaskFailed(task: DetectionTask, code: Int) {
                ...
                when (code) {
                    ...
                    LivenessDetector.ERROR_OUT_OF_DETECTION_RECT -> {
                        ...
                        Toast.makeText(
                            this@AttendanceMidGeoLocationLivenessActivity,
    ...
    private fun finishForResult() {
        ...
        startActivity(Intent(this, AttendanceMidGeoLocationPhoto::class.java).also{
