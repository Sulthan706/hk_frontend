...
class CloseComplaintVisitorClientAdapter(var context: Context, var contentCtalkVisitorClients: ArrayList<ContentCtalkVisitorClient>)
    :RecyclerView.Adapter<CloseComplaintVisitorClientAdapter.ViewHolder>() {

    private lateinit var ctalkCloseVisitorClientCallBack: CtalkCloseVisitorClientCallBack
    ...
    inner class ViewHolder(val binding: ListComplaintClientBinding):
        ...
        override fun onClick(v: View?) {
            ...
            ctalkCloseVisitorClientCallBack.onClickWaitingComplaintVisitor(getComplaint.complaintId)
        }
    ...
    fun setListener(ctalkCloseVisitorClientCallBack: CtalkCloseVisitorClientCallBack){
        this.ctalkCloseVisitorClientCallBack = ctalkCloseVisitorClientCallBack
    }

    interface CtalkCloseVisitorClientCallBack {
