...
import com.hkapps.hygienekleen.databinding.ActivityListMachineClientBinding
...
class ListMachineClientActivity : AppCompatActivity() {

    private lateinit var binding : ActivityListMachineClientBinding
    ...
    private val bakMachineViewModel by lazy {
        ViewModelProviders.of(this)[HomeClientViewModel::class.java]
    }
    ...
    private fun initView(){
        ...
        binding.appBarBakMachine.llAppbar.setBackgroundResource(R.color.secondary_color)
    ...
    private fun showRecycler(data : List<BakMachine>){
        ...
        val rvLayoutManager = LinearLayoutManager(this@ListMachineClientActivity)
