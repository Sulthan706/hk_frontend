...
import com.hkapps.hygienekleen.databinding.ActivityUpdateNumAccountManagementBinding
...
class UpdateNumAccountManagementActivity : AppCompatActivity() {
    private lateinit var binding: ActivityUpdateNumAccountManagementBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityUpdateNumAccountManagementBinding.inflate(layoutInflater)
        ...
        Log.d("AGRI", "spinner value from pref $accountNameBank")
        setObserver()
        //oncreate
    }
    ...
    private fun submitData() {
        ...
        if (accountName == "0"){
            ...
            homeManagementViewModel.updateNumbAccManagement(employeeId, accountName, numbRekening)
...
//
    private fun setObserver() {
        homeManagementViewModel.updateNumbAccManagementViewModel().observe(this) {
            if (it.code == 200) {
                DialogSuccess()
            } else {
