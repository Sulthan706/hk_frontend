...
import com.hkapps.hygienekleen.databinding.FragmentOngoingComplaintManagementBinding
...
class OngoingComplaintManagementFragment : Fragment(), ComplaintManagementByStatusAdapter.ComplaintByStatusCallBack {

    private lateinit var binding: FragmentOngoingComplaintManagementBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOngoingComplaintManagementBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // set shimmer effect
        binding.shimmerListComplaintManagementOngoing.startShimmerAnimation()
        binding.shimmerListComplaintManagementOngoing.visibility = View.VISIBLE
        binding.rvListComplaintManagementOngoing.visibility = View.GONE

        // set recycler view
        val layoutManager = LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
        binding.rvListComplaintManagementOngoing.layoutManager = layoutManager
...
//        binding.swipeListComplaintManagementOngoing.setOnRefreshListener(SwipeRefreshLayout.OnRefreshListener {
//            Handler().postDelayed(
//                Runnable {
//                    binding.swipeListComplaintManagementOngoing.isRefreshing = false
...
//            )
//        })
        binding.rvListComplaintManagementOngoing.addOnScrollListener(scrollListener)
            ...
            if (isLoading != null) {
                if (isLoading) {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.shimmerListComplaintManagementOngoing.stopShimmerAnimation()
                        binding.shimmerListComplaintManagementOngoing.visibility = View.GONE
                        binding.rvListComplaintManagementOngoing.visibility = View.VISIBLE
                    }, 1500)
                }
            }
        })
        viewModel.getListComplaintManagementResponse().observe(requireActivity()) {
            if (it.code == 200) {
                if (it.data.content.isNotEmpty()) {
                    binding.llEmptyListComplaintManagementOngoing.visibility = View.GONE
                    ...
                    if (page == 0) {
                        ...
                        binding.rvListComplaintManagementOngoing.adapter = rvAdapter
                    } else {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.llEmptyListComplaintManagementOngoing.visibility = View.VISIBLE
                    }, 1500)
                }
            } else {
