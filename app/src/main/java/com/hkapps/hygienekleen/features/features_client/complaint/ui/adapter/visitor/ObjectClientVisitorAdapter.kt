...
class ObjectClientVisitorAdapter(var listObjectCtalkVisitor: ArrayList<Object>): RecyclerView.Adapter<ObjectClientVisitorAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val item = listObjectCtalkVisitor[position]
        holder.binding.tvAreaCtalkVisitor.text = item.namaObject
    ...
    override fun getItemCount(): Int {
        return if (!isExpanded && listObjectCtalkVisitor.size > defaultItemCount) {
            defaultItemCount
        } else {
            listObjectCtalkVisitor.size
        }
    }
