...
//import com.digimaster.carefastoperation.features.features_vendor.homescreen.attendance_fix.model.fab_person_model.fab_person_cspv.DataFabPerson
...
class FabMyTeamAdapter (var myTeam: ArrayList<Content>):
RecyclerView.Adapter<FabMyTeamAdapter.MyViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FabMyTeamAdapter.MyViewHolder {
