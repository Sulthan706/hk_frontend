...
class ListMachineManagementAdapter(
    private val context : Context,
    val data : MutableList<BakMachine>,
    val listener : OnClickMachineManagement
):RecyclerView.Adapter<ListMachineManagementAdapter.ListMachineManagementViewHolder>() {

    inner class ListMachineManagementViewHolder(val binding : ListItemBakMesinBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListMachineManagementViewHolder {
        return ListMachineManagementViewHolder((ListItemBakMesinBinding.inflate(LayoutInflater.from(parent.context),parent,false)))
    }

    override fun getItemCount(): Int  = data.size

    override fun onBindViewHolder(holder: ListMachineManagementViewHolder, position: Int) {
    ...
    interface OnClickMachineManagement{
