...
import com.hkapps.hygienekleen.databinding.FragmentCloseDetailHistoryComplaintClientBinding
...
class CloseDetailHistoryComplaintClientFragment : Fragment(), ListComplaintStatusAdapter.HistoryComplaintStatusCallBack {

    private lateinit var binding: FragmentCloseDetailHistoryComplaintClientBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCloseDetailHistoryComplaintClientBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // set shimmer effect
        binding.shimmerHistoryComplaintClose.startShimmerAnimation()
        binding.shimmerHistoryComplaintClose.visibility = View.VISIBLE
        binding.rvHistoryComplaintClose.visibility = View.GONE

        // set recycler view
        val layoutManager = LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
        binding.rvHistoryComplaintClose.layoutManager = layoutManager
        ...
        binding.swipeHistoryComplaintClose.setOnRefreshListener(SwipeRefreshLayout.OnRefreshListener {
            Handler().postDelayed(
                Runnable {
                    binding.swipeHistoryComplaintClose.isRefreshing = false
        ...
        binding.rvHistoryComplaintClose.addOnScrollListener(scrollListener)
            ...
            if (isLoading != null) {
                if (isLoading) {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.shimmerHistoryComplaintClose.stopShimmerAnimation()
                        binding.shimmerHistoryComplaintClose.visibility = View.GONE
                        binding.rvHistoryComplaintClose.visibility = View.VISIBLE
                    }, 1500)
                }
            }
        })
        viewModel.clientComplaintHistoryResponseModel.observe(requireActivity()) { it ->
            if (it.code == 200) {
                if (it.data.content.isNotEmpty()) {
                    binding.tvEmptycomplaintClose.visibility = View.GONE
                    ...
                    if (page == 0) {
                        ...
                        binding.rvHistoryComplaintClose.adapter = rvAdapter
                    } else {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.tvEmptycomplaintClose.visibility = View.VISIBLE
                    }, 1500)
                }
            } else {
