...
import com.hkapps.hygienekleen.databinding.FragmentListOperationalAbsentMgmntBinding
...
class ListOperationalAbsentMgmntFragment : Fragment(),
    ListOperationalAbsentMgmntAdapter.ListOperationalCallBack {

    private lateinit var binding: FragmentListOperationalAbsentMgmntBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentListOperationalAbsentMgmntBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // set shimmer effect
        binding.shimmerListOperationalAbsent.startShimmerAnimation()
        binding.shimmerListOperationalAbsent.visibility = View.VISIBLE
        binding.rvListOperationalAbsent.visibility = View.GONE
        binding.flNoDataListOperationalAbsent.visibility = View.GONE
        binding.flNoInternetListOperationalAbsent.visibility = View.GONE
        ...
        Log.d("ListOprAbsentMgmntFrag", "onViewCreated: click from $clickFrom")
    ...
    private fun noInternetState() {
        binding.shimmerListOperationalAbsent.visibility = View.GONE
        binding.rvListOperationalAbsent.visibility = View.GONE
        binding.flNoDataListOperationalAbsent.visibility = View.GONE
        binding.flNoInternetListOperationalAbsent.visibility = View.VISIBLE
    ...
    private fun noDataState() {
        ...
        binding.rvListOperationalAbsent.visibility = View.GONE
        binding.flNoInternetListOperationalAbsent.visibility = View.GONE
        binding.flNoDataListOperationalAbsent.visibility = View.VISIBLE
    }
    ...
    private fun viewIsOnline() {
        ...
        binding.rvListOperationalAbsent.layoutManager = layoutManager
            ...
            if (isLoading != null) {
                if (isLoading) {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.shimmerListOperationalAbsent.stopShimmerAnimation()
                        binding.shimmerListOperationalAbsent.visibility = View.GONE
                        binding.rvListOperationalAbsent.visibility = View.VISIBLE
                    }, 1500)
                }
            }
        })
        viewModel.listCountAbsentOprResponseModel.observe(requireActivity()) {
            if (it.code == 200) {
                if (it.data.isNotEmpty()) {
                    ...
                    binding.rvListOperationalAbsent.adapter = rvAdapter
                } else {
                    noDataState()
                }
            } else {
