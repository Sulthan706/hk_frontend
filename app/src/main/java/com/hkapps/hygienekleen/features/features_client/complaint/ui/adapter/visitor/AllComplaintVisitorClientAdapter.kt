...
class AllComplaintVisitorClientAdapter(
    var context: Context,
    var contentCtalkVisitorClients: ArrayList<ContentCtalkVisitorClient>
): RecyclerView.Adapter<AllComplaintVisitorClientAdapter.ViewHolder>() {

    private lateinit var ctalkVisitorClientCallBack: CtalkVisitorClientCallBack
    ...
    RecyclerView.ViewHolder(binding.root), View.OnClickListener{
        ...
        override fun onClick(v: View?) {
            ...
            ctalkVisitorClientCallBack.onClickComplaintVisitor(getComplaint.complaintId)
        }
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AllComplaintVisitorClientAdapter.ViewHolder {
        return ViewHolder(ListComplaintClientBinding.inflate(LayoutInflater.from(parent.context),
            parent,false))
    }

    override fun onBindViewHolder(
        holder: AllComplaintVisitorClientAdapter.ViewHolder,
        position: Int
    ) {
    ...
    fun setListener(ctalkVisitorClientCallBack: CtalkVisitorClientCallBack){
        this.ctalkVisitorClientCallBack = ctalkVisitorClientCallBack
    }

    interface CtalkVisitorClientCallBack {
        fun onClickComplaintVisitor(complaintId: Int)
    }
}
