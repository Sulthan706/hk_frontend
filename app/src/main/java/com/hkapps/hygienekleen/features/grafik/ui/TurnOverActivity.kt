...
import com.hkapps.hygienekleen.databinding.ActivityTurnOverBinding
...
class TurnOverActivity : AppCompatActivity() {
    ...
    private lateinit var binding : ActivityTurnOverBinding
...
//        setDataDummy()
        ...
        if(isManagement){
            turnOverPieChart(projectIdManagement)
            turnOverBarChart(projectIdManagement)
        }else{
