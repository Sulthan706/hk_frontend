package com.hkapps.hygienekleen.features.features_client.home.ui.adapter
...
class ListMachineClientAdapter(
    private val context : Context,
    val data : MutableList<BakMachine>,
    val listener : BakMachineOnClick
) : RecyclerView.Adapter<ListMachineClientAdapter.ListBakMachineViewHolder>() {
