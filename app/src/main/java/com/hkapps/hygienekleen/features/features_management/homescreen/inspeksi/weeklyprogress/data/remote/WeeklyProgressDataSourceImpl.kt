...
class WeeklyProgressDataSourceImpl @Inject constructor(
    private val weeklyProgressService: WeeklyProgressService
) : WeeklyProgressDataSource {
    override fun getListWeeklyProgress(
        ...
        return weeklyProgressService.getListWeeklyProgress(
            projectCode,
            adminMasterId,
            startAt,
            endAt,
    ...
    override fun checkValidation(adminMasterId: Int, date: String): Single<ValidationResponse> {
        return weeklyProgressService.checkValidation(adminMasterId,date)
    }

    override fun getDetailWeeklyProgress(idWeekly: Int): Single<DetailWeeklyResponse> {
        return weeklyProgressService.getDetailWeeklyProgress(idWeekly)
    }
    ...
    override fun createWeeklyProgress(
        ...
        return weeklyProgressService.createWeeklyProgress(
            adminMasterId,
            projectCode,
            location,
            materialType,
    ...
    override fun updateWeeklyProgress(
        ...
        return weeklyProgressService.updateWeeklyProgress(
            idWeekly,
            adminMasterId,
            projectCode,
            location,
