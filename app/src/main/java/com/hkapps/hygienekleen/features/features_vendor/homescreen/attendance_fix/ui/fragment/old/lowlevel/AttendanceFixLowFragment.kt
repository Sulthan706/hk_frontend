package com.hkapps.hygienekleen.features.features_vendor.homescreen.attendance_fix.ui.fragment.old.lowlevel
...
import com.hkapps.hygienekleen.features.features_vendor.homescreen.attendance_fix.ui.activity.lowlevel.old.AttendanceFixLowDailyCheckInActivity
...
class AttendanceFixLowFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(params: Int) =
            AttendanceFixLowFragment().apply {
...
//                            attedanceViewModel.getCheckAttendance(employeeId, projectCode)
//                            getCheckAttendance()
//                        }
...
//                        binding.llCheckOut.setOnClickListener {
//                            val i =
//                                Intent(context, AttendanceFixLowDailyCheckOutActivity::class.java)
//                            startActivity(i)
//                        }
//                    }
//                }
...
//            binding.llCheckIn.setOnClickListener {
//                val i = Intent(context, AttendanceFixLowDailyCheckInActivity::class.java)
//                startActivity(i)
//            }
//
//            binding.llCheckOut.setOnClickListener {
//                context?.getString(R.string.belum_absen)?.let { it1 -> showDialog(it1) }
//            }
//
//            onSNACK(binding.root, "Belum absen")
//        })
//    }
    ...
    @SuppressLint("SetTextI18n")
    private fun getCheckAttendance() {
        attedanceViewModel.attCheck.observe(requireActivity(), {
            if (it.message == "Please wait, schedule not available") {
                context?.getString(R.string.belum_waktunya)?.let { it1 -> showDialog(it1) }
            } else if (it.message == "Scan in available") {
                val i = Intent(context, AttendanceFixLowDailyCheckInActivity::class.java)
                startActivity(i)
            }
        })
