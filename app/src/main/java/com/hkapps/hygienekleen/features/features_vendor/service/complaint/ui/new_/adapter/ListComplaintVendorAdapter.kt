...
class ListComplaintVendorAdapter(
    private val context: Context,
    var listComplaint: ArrayList<ListHistoryComplaint>,
    val statusComplaint: String
) : RecyclerView.Adapter<ListComplaintVendorAdapter.ViewHolder>() {

    private lateinit var listComplaintCallBack: ListComplaintCallBack
    ...
    inner class ViewHolder(val binding: ListComplaintClientBinding) :
        ...
        override fun onClick(p0: View?) {
            ...
            listComplaintCallBack.onClickComplaint(getComplaint.complaintId)
        }
...
//                holder.binding.tvStatusHistoryComplaint.text = "Error"
    ...
    fun setListener(listComplaintCallBack: ListComplaintCallBack) {
        this.listComplaintCallBack = listComplaintCallBack
    }

    interface ListComplaintCallBack {
