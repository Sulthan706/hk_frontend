...
class MyteamWeekdaysFragment : Fragment() {
    ...
    private val dateParams =
        CarefastOperationPref.loadString(CarefastOperationPrefConst.DATE_PARAMS_MYTEAM, "")
    ...
    private val teamleadId =
        CarefastOperationPref.loadInt(CarefastOperationPrefConst.MY_TEAM_TL_ID, 0)
