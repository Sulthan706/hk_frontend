...
class ListComplaintManagementAdapter(
    private val context: Context,
    var listComplaint: ArrayList<Content>
) : RecyclerView.Adapter<ListComplaintManagementAdapter.ViewHolder>() {

    private lateinit var complaintCallBack: ListComplaintCallBack
    ...
    fun setListener(listComplaintCallBack: ListComplaintCallBack) {
        this.complaintCallBack = listComplaintCallBack
    }
