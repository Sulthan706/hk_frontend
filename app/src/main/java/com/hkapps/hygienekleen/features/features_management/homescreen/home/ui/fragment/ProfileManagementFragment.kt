...
import com.hkapps.hygienekleen.features.features_management.homescreen.home.ui.activity.*
...
import com.hkapps.hygienekleen.features.features_management.homescreen.home.ui.activity.updateprofilemngmnt.UpdateNumAccountManagementActivity
import com.hkapps.hygienekleen.features.features_management.homescreen.home.ui.activity.updateprofilemngmnt.UpdateNumberFamilyManagementActivity
...
class ProfileManagementFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imgSettings.setOnClickListener {
            val i = Intent(context, SettingsManagementActivity::class.java)
            startActivity(i)
        }
        ...
        Log.d("AGRI", "level $userLevel")
        if (userLevel == "Operator"){
            binding.rlLocationProject.visibility = View.VISIBLE
        } else {
            binding.rlLocationProject.visibility = View.GONE
        }
...
//                }
                ...
                viewModel.getProfileManagement(employeeId)
                setObserver()
    ...
    private fun setObserver() {
        viewModel.getProfileManagementModel().observe(requireActivity(), Observer {

            Handler().postDelayed(
                Runnable {
                    if (it.code == 200) {
//                        CarefastOperationPref.saveString(
//                            CarefastOperationPrefConst.NUMBER_NIK,
//                            it.data.
//                        )
                        //validation penempatan

//                        binding.tvProjectNames.text = it.data.project.projectName
...
//                        validation check
                        ...
                        binding.rlBtnProfileMain.setOnClickListener {
                            startActivity(Intent(context, EditProfileManagementActivity::class.java))
                        }
                        ...
                        binding.rlBtnProfileRekening.setOnClickListener { _ ->
                            ...
                            startActivity(Intent(context, UpdateNumAccountManagementActivity::class.java))
                            ...
                            if (!it.data.checkBankingAccount) {
                                ...
                                CarefastOperationPref.saveString(
                                    ...
                                    it.data.bankingNumber.toString()
                                )
                        ...
                        binding.rlBtnProfileNomerKK.setOnClickListener { _ ->
                            ...
                            startActivity(Intent(context, UpdateNumberFamilyManagementActivity::class.java))
                            if (!it.data.checkFamilyCard) {
                                CarefastOperationPref.saveString(
                                ...
                                CarefastOperationPref.saveString(
                                    CarefastOperationPrefConst.NUMBERKK,
                                    it.data.familyCardNumber.toString()
                                )
                        ...
                        binding.rlBtnProfileDokumen.setOnClickListener {
                            startActivity(Intent(context, UpdateDocumentManagementActivity::class.java))
                        }
                        binding.rlBtnProfileSertifikatVaksin.setOnClickListener {
                            startActivity(
                                Intent(
                                    context,
                                    ListVaccineManagementActivity::class.java
                                )
                            )
                        }
                        ...
                        binding.tvProjectNames.text = "Unknown project name"
                    }
