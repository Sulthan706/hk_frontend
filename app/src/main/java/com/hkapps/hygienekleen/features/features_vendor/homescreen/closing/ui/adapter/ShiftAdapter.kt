...
class ShiftAdapter(var listChooserInspeksi: List<DetailShift>,
    ...
    override fun onBindViewHolder(holder: ShiftAdapter.ViewHolder, position: Int) {
        val response = listChooserInspeksi[position]

        holder.binding.tvItemChooser.text = response.shift.shiftDescription
    ...
    interface OnItemSelectedCallBack {
        fun onItemSelected(detailShift: DetailShift)
    }
