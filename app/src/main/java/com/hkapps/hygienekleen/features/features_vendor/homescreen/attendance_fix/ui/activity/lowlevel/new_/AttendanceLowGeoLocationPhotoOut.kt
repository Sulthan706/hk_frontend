...
import com.hkapps.hygienekleen.databinding.ActivityAttendanceLowGeoLocationPhotoOutBinding
...
class AttendanceLowGeoLocationPhotoOut : AppCompatActivity() {

    private lateinit var binding: ActivityAttendanceLowGeoLocationPhotoOutBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAttendanceLowGeoLocationPhotoOutBinding.inflate(layoutInflater)
    ...
    private fun setObserver(image : ArrayList<String>) {
        ...
        viewModel.getSelfie().observe(this) {
            when (it.code) {
                200 -> {
                    hideLoading()
