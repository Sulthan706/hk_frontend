...
import com.hkapps.hygienekleen.databinding.ActivityChangeCertificateVaksinBinding
import com.hkapps.hygienekleen.features.features_management.homescreen.home.ui.activity.updateprofilemngmnt.UploadVaccineManagementActivity
import com.hkapps.hygienekleen.features.features_vendor.homescreen.home.ui.new_.fragment.BotSheetChangeVaccineFragment
...
class ChangeCertificateVaksinActivity : AppCompatActivity() {
    private lateinit var binding: ActivityChangeCertificateVaksinBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val urlClient =
            this.getString(R.string.url) + "/assets.admin_master/images/vaccine/$imgClient"
...
//            holder.iv.setImageDrawable(res)
        ...
        binding.btnUploadDocument.setOnClickListener {
            if (changeVaccine == "change") {
                ...
                BotSheetChangeVaccineFragment().show(supportFragmentManager, "bottomsheet")
            }
        }
    ...
    private fun setObserver() {
        viewModel.changeVaccineViewModel().observe(this) {
            if (it.code == 200) {
                Toast.makeText(this, "sukses ganti", Toast.LENGTH_SHORT).show()
                //use for ended a activity
                finish()
            } else {
    ...
    private fun showLoading(loadingText: String) {
        ...
        viewModel.changeCertificateVaccine(idVaccine, image)
    }
