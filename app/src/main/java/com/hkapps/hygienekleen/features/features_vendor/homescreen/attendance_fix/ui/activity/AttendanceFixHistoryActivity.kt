package com.hkapps.hygienekleen.features.features_vendor.homescreen.attendance_fix.ui.activity
...
import com.hkapps.hygienekleen.features.features_vendor.homescreen.attendance_fix.model.HistoryByDateResponseModel
import com.hkapps.hygienekleen.features.features_vendor.homescreen.attendance_fix.model.HistoryResponseModel
...
import com.hkapps.hygienekleen.features.features_vendor.homescreen.attendance_fix.ui.adapter.new_.lowlevel.AttendanceFixHistoryAdapter
import com.hkapps.hygienekleen.features.features_vendor.homescreen.attendance_fix.ui.adapter.new_.lowlevel.AttendanceFixHistoryByDateAdapter
...
class AttendanceFixHistoryActivity : AppCompatActivity(), NoInternetConnectionCallback {
    ...
    private lateinit var historyAdapter: AttendanceFixHistoryAdapter
    private lateinit var historyByDateAdapter: AttendanceFixHistoryByDateAdapter
    private lateinit var historyResponseModel: HistoryResponseModel
    private lateinit var historyByDateResponseModel: HistoryByDateResponseModel
    ...
    private val employeeName = CarefastOperationPref.loadString(CarefastOperationPrefConst.USER_NAME, "")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.layoutAppbarAttendanceHistory.tvAppbarTitle.text = "Riwayat Absen $employeeName"
                ...
                if (it.historyDataArrayByDateResponseModel.isNotEmpty()) {
                    ...
                    val progressRunnable = Runnable {
                        ...
                        historyByDateAdapter =
                            AttendanceFixHistoryByDateAdapter(
