...
class CalendarSchedulesBodAdapter(
    val listSchedule: ArrayList<Content>
): RecyclerView.Adapter<CalendarSchedulesBodAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.tvPlanningInfoScheduleManagement.visibility = View.INVISIBLE
