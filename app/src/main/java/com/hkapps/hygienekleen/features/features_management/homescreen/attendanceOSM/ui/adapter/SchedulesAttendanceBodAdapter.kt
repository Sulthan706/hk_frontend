...
import com.hkapps.hygienekleen.features.features_management.homeScreenUpdated.homeUpdated.model.listRemainingVisitBod.Content
import com.hkapps.hygienekleen.features.features_vendor.service.permission.ui.activity.customcalendar.setTextColorRes

class SchedulesAttendanceBodAdapter (
    private var context: Context,
    var listProjectManagement: ArrayList<Content>
    ): RecyclerView.Adapter<SchedulesAttendanceBodAdapter.ViewHolder>() {

    private lateinit var schdAttnBodCallBack: SchdAttnBodCallBack
    var selectedItem = -1
    ...
    inner class ViewHolder(val binding: ListProjectBinding):
        ...
        override fun onClick(p0: View?) {
            ...
            schdAttnBodCallBack.onClickSchdAttnBod(project.projectCode, project.projectName, project.idRkbBod, latitude, longitude, radius)
    ...
    fun setListener(schdAttnBodCallBack: SchdAttnBodCallBack) {
        this.schdAttnBodCallBack = schdAttnBodCallBack
    }

    interface SchdAttnBodCallBack {
        fun onClickSchdAttnBod(projectCode: String, projectName: String, idRkbBod: Int, latitude: String, longitude: String, radius: Int)
    }
}