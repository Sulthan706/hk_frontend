...
import com.hkapps.hygienekleen.features.features_vendor.homescreen.attendance_fix.ui.adapter.old.midlevel.ViewPagerFixMidAdapter
...
class AttendanceFixMidActivity : AppCompatActivity(), NoInternetConnectionCallback {

    private lateinit var binding: ActivityAttendanceBinding
    lateinit var viewpageradapter: ViewPagerFixMidAdapter //Declare PagerAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewpageradapter = ViewPagerFixMidAdapter(supportFragmentManager, page, name.toString(), this)
...
//        set timer cuma 1.1 detik buat loadingnya
    ...
    override fun onRetry() {
        val i = Intent(this, AttendanceFixMidActivity::class.java)
        startActivity(i)
    }
