...
import com.hkapps.hygienekleen.databinding.FragmentListSpvAbsentMgmntBinding
...
class ListSpvAbsentMgmntFragment : Fragment(),
    ListOperationalAbsentMgmntAdapter.ListOperationalCallBack {

    private lateinit var binding: FragmentListSpvAbsentMgmntBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentListSpvAbsentMgmntBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // set shimmer effect
        binding.shimmerListSpvAbsent.startShimmerAnimation()
        binding.shimmerListSpvAbsent.visibility = View.VISIBLE
        binding.rvListSpvAbsent.visibility = View.GONE
        binding.flNoDataListSpvAbsent.visibility = View.GONE
        binding.flNoInternetListSpvAbsent.visibility = View.GONE
    ...
    private fun noInternetState() {
        binding.shimmerListSpvAbsent.visibility = View.GONE
        binding.rvListSpvAbsent.visibility = View.GONE
        binding.flNoDataListSpvAbsent.visibility = View.GONE
        binding.flNoInternetListSpvAbsent.visibility = View.VISIBLE
    ...
    private fun noDataState() {
        ...
        binding.rvListSpvAbsent.visibility = View.GONE
        binding.flNoInternetListSpvAbsent.visibility = View.GONE
        binding.flNoDataListSpvAbsent.visibility = View.VISIBLE
    }
    ...
    private fun viewIsOnline() {
        ...
        binding.rvListSpvAbsent.layoutManager = layoutManager
            ...
            if (isLoading != null) {
                if (isLoading) {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.shimmerListSpvAbsent.stopShimmerAnimation()
                        binding.shimmerListSpvAbsent.visibility = View.GONE
                        binding.rvListSpvAbsent.visibility = View.VISIBLE
                    }, 1500)
                }
            }
        })
        viewModel.listCountAbsentOprResponseModel.observe(requireActivity()) {
            if (it.code == 200) {
                if (it.data.isNotEmpty()) {
                    ...
                    binding.rvListSpvAbsent.adapter = rvAdapter
                } else {
                    noDataState()
                }
            } else {
