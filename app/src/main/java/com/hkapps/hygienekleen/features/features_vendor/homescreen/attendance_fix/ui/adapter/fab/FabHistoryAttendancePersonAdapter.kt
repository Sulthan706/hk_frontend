...
class FabHistoryAttendancePersonAdapter(private var myTeam: List<Content>) :
    RecyclerView.Adapter<FabHistoryAttendancePersonAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val urls =
            context!!.getString(R.string.url) + "assets.admin_master/images/photo_profile/" + item.employeePhotoProfile
