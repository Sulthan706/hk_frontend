...
import com.hkapps.hygienekleen.databinding.ListPengawasReportBinding
import com.hkapps.hygienekleen.features.features_client.report.model.jadwalkerja.Pengawas

class ListPengawasReportAdapter(
    private val context: Context,
    var listPengawas: ArrayList<Pengawas>):
RecyclerView.Adapter<ListPengawasReportAdapter.ViewHolder>(){
    inner class ViewHolder(val binding: ListPengawasReportBinding):
            RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ListPengawasReportBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val response = listPengawas[position]
        ...
        when (response.statusAttendance) {
            ...
            "TIDAK_HADIR", "Tidak_hadir", "Tidak_Hadir" -> {
