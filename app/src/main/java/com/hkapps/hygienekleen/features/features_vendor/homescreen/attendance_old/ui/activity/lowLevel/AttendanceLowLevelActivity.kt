package com.hkapps.hygienekleen.features.features_vendor.homescreen.attendance_old.ui.activity.lowLevel
...
import com.hkapps.hygienekleen.databinding.ActivityAttendanceLowLevelBinding
import com.hkapps.hygienekleen.features.features_vendor.homescreen.attendance_old.ui.activity.AttendanceHistoryActivity
import com.hkapps.hygienekleen.features.features_vendor.homescreen.attendance_old.ui.adapter.lowLevel.ViewPagerLowLevelAdapter
...
class AttendanceLowLevelActivity : AppCompatActivity(), NoInternetConnectionCallback {

    private lateinit var binding: ActivityAttendanceLowLevelBinding
    lateinit var viewpageradapter: ViewPagerLowLevelAdapter //Declare PagerAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAttendanceLowLevelBinding.inflate(layoutInflater)
        ...
        viewpageradapter = ViewPagerLowLevelAdapter(supportFragmentManager, page, name.toString(), this)
...
//        set timer cuma 1.1 detik buat loadingnya
    ...
    override fun onRetry() {
        val i = Intent(this, AttendanceLowLevelActivity::class.java)
        startActivity(i)
    }
