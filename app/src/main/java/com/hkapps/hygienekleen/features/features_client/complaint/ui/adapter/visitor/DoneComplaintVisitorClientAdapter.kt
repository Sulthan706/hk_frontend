...
class DoneComplaintVisitorClientAdapter(var context: Context, var contentCtalkVisitorClients: ArrayList<ContentCtalkVisitorClient>):
RecyclerView.Adapter<DoneComplaintVisitorClientAdapter.ViewHolder>(){

    private lateinit var ctalkDoneVisitorClientCallBack: CtalkDoneVisitorClientCallBack
    ...
    inner class ViewHolder(val binding: ListComplaintClientBinding):
        ...
        override fun onClick(v: View?) {
            ...
            ctalkDoneVisitorClientCallBack.onClickDoneComplaintVisitor(getComplaint.complaintId)
        }
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): DoneComplaintVisitorClientAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(
        holder: DoneComplaintVisitorClientAdapter.ViewHolder,
        position: Int
    ) {
    ...
    fun setListener(ctalkDoneVisitorCallback: CtalkDoneVisitorClientCallBack){
        this.ctalkDoneVisitorClientCallBack = ctalkDoneVisitorCallback
    }

    interface CtalkDoneVisitorClientCallBack {
        fun onClickDoneComplaintVisitor(complaintId: Int)
    }
}