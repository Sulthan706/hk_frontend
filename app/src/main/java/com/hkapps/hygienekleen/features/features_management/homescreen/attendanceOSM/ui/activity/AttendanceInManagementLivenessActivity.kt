...
class AttendanceInManagementLivenessActivity : AppCompatActivity() {

    private lateinit var binding : ActivityAttendanceInManagementLivenessBinding
...
//                    binding.tvGesture.text = randomizedTasks[currentTaskIndex]
            ...
            override fun onTaskFailed(task: DetectionTask, code: Int) {
                ...
                when (code) {
                    ...
                    LivenessDetector.ERROR_OUT_OF_DETECTION_RECT -> {
                        ...
                        Toast.makeText(
                            this@AttendanceInManagementLivenessActivity,
    ...
    private fun finishForResult(){
        ...
        startActivity(Intent(this,AttendanceInManagementActivity::class.java).also{
