...
import com.hkapps.hygienekleen.databinding.ActivityDetailHistoryPermissionManagementBinding
import com.hkapps.hygienekleen.features.features_management.service.permission.viewmodel.PermissionManagementViewModel
import com.hkapps.hygienekleen.features.features_vendor.service.permission.ui.activity.midlevel.DetailHistoryPermissionActivity
...
class DetailHistoryPermissionManagementActivity : AppCompatActivity() {

    private lateinit var binding: ActivityDetailHistoryPermissionManagementBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDetailHistoryPermissionManagementBinding.inflate(layoutInflater)
    ...
    private fun setObserver() {
        ...
        viewModel.detailPermissionModel.observe(this) {
            if (it.code == 200) {
                // set data
                ...
                binding.tvDateDetailHistoryPermissionMid.text = "${it.data.startDate} -"
                binding.tvShiftDetailHistoryPermissionMid.text = it.data.endDate
        ...
        viewModel.uploadPhotoPermissionModel.observe(this) {
            if (it.code == 200) {
                hideLoading()
                Toast.makeText(this, "Berhasil upload foto izin", Toast.LENGTH_SHORT).show()
                startActivity(Intent(this, DetailHistoryPermissionManagementActivity::class.java))
                finish()
            } else {
                hideLoading()
                binding.layoutPreviewUploadPhotoPermission.btnPreviewUploadPhoto.isEnabled = true
    ...
    private fun loadData() {
        viewModel.getDetailPermissionManagement(permissionId)
    }
    ...
    private fun makeRequest() {
        ActivityCompat.requestPermissions(
            ...
            DetailHistoryPermissionActivity.CAMERA_REQ
        )
    }
