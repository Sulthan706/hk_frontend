...
import com.hkapps.hygienekleen.databinding.FragmentDoneCftalksProjectBinding
...
class DoneCftalksProjectFragment : Fragment(),
    StatusCftalksProjectAdapter.CftalkManagementCallBack {

    private lateinit var binding: FragmentDoneCftalksProjectBinding
...
//    private val projectId = "CFHO"
    ...
    override fun onCreateView(
        ...
        binding = FragmentDoneCftalksProjectBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // set shimmer effect
        binding.shimmerDoneCftalkProject.startShimmerAnimation()
        binding.shimmerDoneCftalkProject.visibility = View.VISIBLE
        binding.rvDoneCftalkProject.visibility = View.GONE

        // set recycler view
        val layoutManager = LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
        binding.rvDoneCftalkProject.layoutManager = layoutManager
        ...
        binding.swipeDoneCftalkProject.setOnRefreshListener(SwipeRefreshLayout.OnRefreshListener {
            Handler().postDelayed(
                Runnable {
                    binding.swipeDoneCftalkProject.isRefreshing = false
        ...
        binding.rvDoneCftalkProject.addOnScrollListener(scrollListener)
            ...
            if (isLoading != null) {
                if (isLoading) {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.shimmerDoneCftalkProject.stopShimmerAnimation()
                        binding.shimmerDoneCftalkProject.visibility = View.GONE
                        binding.rvDoneCftalkProject.visibility = View.VISIBLE
                    }, 1500)
                }
            }
        })
        viewModel.complaintsByProjectModel.observe(requireActivity()) {
            if (it.code == 200) {
                if (it.data.content.isNotEmpty()) {
                    binding.tvDoneCftalkProject.visibility = View.GONE
                    ...
                    if (page == 0) {
                        ...
                        binding.rvDoneCftalkProject.adapter = rvAdapter
                    } else {
                    ...
                    binding.rvDoneCftalkProject.adapter = null
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.tvDoneCftalkProject.visibility = View.VISIBLE
                    }, 1500)
                }
            } else {
