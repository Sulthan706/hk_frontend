...
import com.hkapps.hygienekleen.features.features_management.homeScreenUpdated.visitReport.model.dailyVisitReportManagement.Content

class DailyVisitsManagementAdapter(
    var dailyVisits: ArrayList<Content>
) : RecyclerView.Adapter<DailyVisitsManagementAdapter.ViewHolder>(){
