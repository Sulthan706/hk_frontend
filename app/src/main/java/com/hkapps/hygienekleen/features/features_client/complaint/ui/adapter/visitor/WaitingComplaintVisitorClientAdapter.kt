...
class WaitingComplaintVisitorClientAdapter
    (var context: Context, var contentCtalkVisitorClients: ArrayList<ContentCtalkVisitorClient>)
    :RecyclerView.Adapter<WaitingComplaintVisitorClientAdapter.ViewHolder>() {

    private lateinit var ctalkWaitingVisitorClientCallBack: CtalkWaitingVisitorCallBack
    ...
    inner class ViewHolder(val binding: ListComplaintClientBinding):
        ...
        init {
            ...
            override fun onClick(v: View?) {
                ...
                ctalkWaitingVisitorClientCallBack.onClickWaitingComplaintVisitor(getComplaint.complaintId)
            }
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): WaitingComplaintVisitorClientAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(
        holder: WaitingComplaintVisitorClientAdapter.ViewHolder,
        position: Int
    ) {
    ...
    fun setListener(ctalkWaitingVisitorCallback: CtalkWaitingVisitorCallBack){
        this.ctalkWaitingVisitorClientCallBack = ctalkWaitingVisitorCallback
    }

    interface CtalkWaitingVisitorCallBack {
        fun onClickWaitingComplaintVisitor(complaintId: Int)
    }
