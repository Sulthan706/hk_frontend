...
import com.hkapps.hygienekleen.databinding.FragmentListSpvProfileProjectBinding
...
class ListSpvProfileProjectFragment : Fragment(), ListOperationalProfileProjectAdapter.ListOperationalProfileProjectCallback {

    private lateinit var binding: FragmentListSpvProfileProjectBinding
    ...
    private val jobRole = "Supervisor"
    ...
    override fun onCreateView(
        ...
        binding = FragmentListSpvProfileProjectBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun viewIsOnline(){
        //set shimmer effect
        binding.shimmerListSpvProfileProject.startShimmerAnimation()
        binding.shimmerListSpvProfileProject.visibility = View.VISIBLE
        binding.rvListSpv.visibility = View.GONE
        binding.flListSpvNoInternet.visibility = View.GONE
        binding.flListSpvNoData.visibility = View.GONE

        val layoutManager = LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false)
        binding.rvListSpv.layoutManager = layoutManager
        ...
        binding.rvListSpv.addOnScrollListener(scrollListener)
        loadData()
        setObserver()
    }
            ...
            if (isLoading != null) {
                if (isLoading) {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.shimmerListSpvProfileProject.stopShimmerAnimation()
                        binding.shimmerListSpvProfileProject.visibility = View.GONE
                        binding.rvListSpv.visibility = View.VISIBLE
                    }, 1500)
                }
            }
        })
            ...
            if(it.code == 200){
                if(it.data.content.isNotEmpty()){
                    ...
                    if(page == 0){
                        ...
                        binding.rvListSpv.adapter = adapter
                    }else{
    ...
    private fun noInternetState() {
        ...
        binding.rvListSpv.visibility = View.GONE
        binding.flListSpvNoData.visibility = View.GONE
        binding.flListSpvNoInternet.visibility = View.VISIBLE
    ...
    private fun noDataState() {
        ...
        binding.rvListSpv.visibility = View.GONE
        binding.flListSpvNoInternet.visibility = View.GONE
        binding.flListSpvNoData.visibility = View.VISIBLE
    }
