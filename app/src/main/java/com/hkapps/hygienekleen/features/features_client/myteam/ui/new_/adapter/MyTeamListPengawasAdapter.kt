...
class MyTeamListPengawasAdapter(
    private val context: Context,
    var pengawasMyTeam: ArrayList<Pengawas>) :
    RecyclerView.Adapter<MyTeamListPengawasAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val response = pengawasMyTeam[position]
