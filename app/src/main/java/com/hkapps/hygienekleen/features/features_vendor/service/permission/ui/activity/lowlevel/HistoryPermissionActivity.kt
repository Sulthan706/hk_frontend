...
class HistoryPermissionActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // set appbar layout
        binding.appbarHistorypermission.tvAppbarTitle.text = "Izin"
        ...
        binding.rvHistoryPermission.visibility = View.INVISIBLE
        ...
        binding.rvHistoryPermission.addOnScrollListener(scrollListener)
...
//        }
        ...
        binding.swipeHistoryPermission.setOnRefreshListener{
            Handler().postDelayed( {
        ...
        binding.ivCreateComplaint.setOnClickListener {
            when(message) {
                "VALID" -> {
                    ...
                    startActivityForResult(Intent(this, CreatePermissionFixActivity::class.java), CREATE_CODE)
                }
                "INVALID" -> {
                ...
                else -> Toast.makeText(this, "Error validasi izin", Toast.LENGTH_SHORT).show()
            }
        }
...
//        viewModel.getHistoryPermission(projectId, userId, page)
...
//        viewModel.historyResponseModel.observe(this) { it ->
//            if (it.code == 200) {
...
//                            this,
//                            it.data.content as ArrayList<ListHistoryPermission>
...
//                }
//            } else {
//                Toast.makeText(this, "Gagal mengambil data izin", Toast.LENGTH_SHORT).show()
//            }
//        }
