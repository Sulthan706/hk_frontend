...
import com.hkapps.hygienekleen.databinding.ActivityAttendanceMidGeoLocationLivenessOutBinding
...
class AttendanceMidGeoLocationLivenessOutActivity : AppCompatActivity() {

    private lateinit var binding : ActivityAttendanceMidGeoLocationLivenessOutBinding

    private val faceRecognitionViewModel: FaceRecogViewModel by lazy {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAttendanceMidGeoLocationLivenessOutBinding.inflate(layoutInflater)
...
//                    binding.tvGesture.text = randomizedTasks[currentTaskIndex]
            ...
            override fun onTaskFailed(task: DetectionTask, code: Int) {
                ...
                when (code) {
                    ...
                    LivenessDetector.ERROR_OUT_OF_DETECTION_RECT -> {
                        ...
                        Toast.makeText(
                            this@AttendanceMidGeoLocationLivenessOutActivity,
    ...
    private fun finishForResult() {
        ...
        startActivity(Intent(this, AttendanceMidGeoLocationPhotoOut::class.java).also{
