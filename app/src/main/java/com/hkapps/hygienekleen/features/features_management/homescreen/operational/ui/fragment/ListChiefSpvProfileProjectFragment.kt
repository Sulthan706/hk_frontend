...
import com.hkapps.hygienekleen.databinding.FragmentListChiefSpvProfileProjectBinding
...
class ListChiefSpvProfileProjectFragment : Fragment(), ListOperationalProfileProjectAdapter.ListOperationalProfileProjectCallback {

    private lateinit var binding: FragmentListChiefSpvProfileProjectBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentListChiefSpvProfileProjectBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun viewIsOnline(){
        //set shimmer effect
        binding.shimmerListChiefSpvProfileProject.startShimmerAnimation()
        binding.shimmerListChiefSpvProfileProject.visibility = View.VISIBLE
        binding.rvListChiefSpv.visibility = View.GONE
        binding.flListChiefSpvNoInternet.visibility = View.GONE
        binding.flListChiefSpvNoData.visibility = View.GONE

        val layoutManager = LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false)
        binding.rvListChiefSpv.layoutManager = layoutManager
        ...
        binding.rvListChiefSpv.addOnScrollListener(scrollListener)
        loadData()
        setObserver()
    }
            ...
            if (isLoading != null) {
                if (isLoading) {
                    ...
                    Handler(Looper.getMainLooper()).postDelayed(Runnable {
                        binding.shimmerListChiefSpvProfileProject.stopShimmerAnimation()
                        binding.shimmerListChiefSpvProfileProject.visibility = View.GONE
                        binding.rvListChiefSpv.visibility = View.VISIBLE
                    }, 1500)
                }
            }
        })
            ...
            if(it.code == 200){
                if(it.data.content.isNotEmpty()){
                    ...
                    if(page == 0){
                        ...
                        binding.rvListChiefSpv.adapter = adapter
                    }else{
    ...
    private fun noInternetState() {
        ...
        binding.rvListChiefSpv.visibility = View.GONE
        binding.flListChiefSpvNoData.visibility = View.GONE
        binding.flListChiefSpvNoInternet.visibility = View.VISIBLE
    ...
    private fun noDataState() {
        ...
        binding.rvListChiefSpv.visibility = View.GONE
        binding.flListChiefSpvNoInternet.visibility = View.GONE
        binding.flListChiefSpvNoData.visibility = View.VISIBLE
    }
