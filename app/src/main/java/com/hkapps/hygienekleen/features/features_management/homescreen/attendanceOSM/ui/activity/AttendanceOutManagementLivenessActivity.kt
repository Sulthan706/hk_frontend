...
import com.hkapps.hygienekleen.databinding.ActivityAttendanceOutManagementLivenessBinding
...
class AttendanceOutManagementLivenessActivity : AppCompatActivity() {

    private lateinit var binding : ActivityAttendanceOutManagementLivenessBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAttendanceOutManagementLivenessBinding.inflate(layoutInflater)
...
//                    binding.tvGesture.text = randomizedTasks[currentTaskIndex]
            ...
            override fun onTaskFailed(task: DetectionTask, code: Int) {
                ...
                when (code) {
                    ...
                    LivenessDetector.ERROR_OUT_OF_DETECTION_RECT -> {
                        ...
                        Toast.makeText(
                            this@AttendanceOutManagementLivenessActivity,
    ...
    private fun finishForResult(){
        ...
        startActivity(Intent(this,AttendanceOutManagementActivity::class.java).also{
