...
import com.hkapps.hygienekleen.databinding.FragmentMyteamMiddleBinding
...
class MiddleTeamSpvFragment : Fragment(), ListLeaderAdapter.ListLeaderCallback {

    private lateinit var binding: FragmentMyteamMiddleBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMyteamMiddleBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun viewIsOnline() {
        ...
        binding.shimmerShiftMiddle.startShimmerAnimation()
        binding.shimmerShiftMiddle.visibility = View.VISIBLE
        binding.rvAnggotaShiftMiddle.visibility = View.GONE

        // set recyclerview layout
        val layoutManager = LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false)
        binding.rvAnggotaShiftMiddle.layoutManager = layoutManager

        binding.flShiftMiddleNoData.visibility = View.GONE
        binding.flShiftMiddleNoInternet.visibility = View.GONE
        setObserver()
        loadData()
    }
        ...
        if (isLoading != null) {
            if (isLoading) {
                ...
                Handler(Looper.getMainLooper()).postDelayed(Runnable {
                    binding.shimmerShiftMiddle.stopShimmerAnimation()
                    binding.shimmerShiftMiddle.visibility = View.GONE
                    binding.rvAnggotaShiftMiddle.visibility = View.VISIBLE
                }, 1500)
            }
        }
        ...
        viewModel.listLeaderNewModel.observe(requireActivity()) {
            if (it.code == 200) {
                if (it.data.isNotEmpty()) {
                    ...
                    binding.rvAnggotaShiftMiddle.adapter = adapter
                } else {
                    binding.shimmerShiftMiddle.visibility = View.GONE
                    binding.rvAnggotaShiftMiddle.visibility = View.GONE
                    binding.flShiftMiddleNoData.visibility = View.VISIBLE
//                    Toast.makeText(context, "Tidak ada data", Toast.LENGTH_SHORT).show()
    ...
    private fun noInternetState() {
        ...
        binding.rvAnggotaShiftMiddle.visibility = View.GONE
        binding.flShiftMiddleNoData.visibility = View.GONE
        binding.flShiftMiddleNoInternet.visibility = View.VISIBLE
    ...
    override fun onClickLeader(leaderId: Int, leaderName: String, shiftId: Int, projectId: String) {
        ...
        i.putExtra("ProjectIdTlMiddle", projectId)
        startActivity(i)
    }
